...
<div id="header_menu">
	<ul>
		<a href="/#about" id="about_btn"><li class="menu_li">ABOUT</li></a>
		<a href="/#rooms" id="rooms_btn"><li class="menu_li">ROOMS</li></a>
		<a href="/#event" id="event_btn"><li class="menu_li">EVENT</li></a>
		<a href="/#service" id="service_btn"><li class="menu_li">SERVICE</li></a>
	</ul>
</div>
<div id="member">
	<ul>
	...
	<div class="modal_container">
		...
		<div class="modal_body mx-2">
			...
			<div class="form-group mb-3"> 아이디 
				<input class="modal_input mb-1" type="text" id="m_id_update" name="m_Id" placeholder="아이디, 영문자/숫자 (8-20자)" disabled="">
			</div>
			<div class="form-group mb-3"> 
				<label class="form-label" style="width: 100%"> 비밀번호 <strong class="emphasis">(변경가능)</strong>
					<input class="modal_input mb-1" type="password" id="m_pw_update" name="m_Pw" placeholder="변경할 비밀번호, 영문자/숫자/특수문자 (8-20자)">
			...
			<div class="form-group mb-3">
				<label class="form-label" style="width: 100%"> 이름 
					<input class="modal_input mb-2" type="text" id="m_name_update" name="m_Name" placeholder="이름" disabled>
				</label>
			</div>
			...
			<div class="form-group mb-3">
				<label class="form-label" style="width: 100%"> 핸드폰 번호 <strong class="emphasis">(변경가능)</strong>
					<input class="modal_input" type="tel" id="m_phone_update" name="m_Phone" placeholder="핸드폰 번호">
				</label>
			</div>
			...
			<div class="form-group mb-3">
				<label class="form-label" style="width: 100%"> E-mail <strong class="emphasis">(변경가능)</strong>
					<input class="modal_input" type="email" id="m_email_update" name="m_Email" placeholder="E-mail">
				</label>
			</div>
...
<div class="modal" id="delete_form_modal" tabindex="-1" aria-labelledby="register_form" aria-hidden="true">
	<div class="modal_container">
		...
		<div class="modal_body mb-3">
			<button class="modal_main_btn_yes" id="modal_delete">예</button>
